...
OUTPUT_DIR = os.path.join(SCRIPT_DIR, 'output_final_figure_end')
...
def run_comparative_shap_analysis(base_df):
    ...
    # Save the figure
    output_path = os.path.join(OUTPUT_DIR, 'figure_supplemental_xgboost_brain_comparison.pdf')
